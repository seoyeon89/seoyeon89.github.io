...
const MyInfoSection = (props) => {
    return (
        <Accordion initOpen={props.initOpen}
                   title={props.title}
        >
            {
    ...
    return (
        <section className="profile">
            ...
            <div className="profile__card">
                ...
                <div className="profile__card__info">
                    ...
                    <ul className="profile__card__info__content">
                        ...
                        {/*       href="https://github.com/seoyeon89" target="_blank">*/}
                        {/*        <i>*/}
            ...
            <div className="profile__blocks">
                <Accordion title="Hello World!" initOpen={true}>
                    <div className="introduce">
                        ...
                        <p>다양한 직군과 함께 <strong>효율적인 UIUX를 만드는 데</strong> 관심이 많습니다. 폭넓은 탐구를 통해 <strong>다양한 개발 스택을 쌓는 것을 좋아</strong>합니다. 신기술을 접목하여 레거시 소스를 리펙토링 하는데 능숙합니다.</p>
                    </div>
                </Accordion>
                <Accordion title="Skills & Tools" initOpen={false}>
                    <div className="skills">
                        <div className="skills__item">
                            ...
                            <div className="skills__item__box">
                                ...
                                <ul className="list-bullet">
                                    <li>Vue, React에 대한 간단한 이해가 있으며, PHP환경에서의 퍼블리싱 경험이 있습니다.</li>
                ...
                <MyInfoSection title="Work Experience" objectKey="experience" initOpen={false}/>
                <MyInfoSection title="Education" objectKey="education" initOpen={false}/>
            </div>
        </section>
    );
};
